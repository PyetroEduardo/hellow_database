...
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`FK_fornecedor_evento` (
  ...
  INDEX `fk_fornecedor_has_fornecedor_fornecedor2_idx` (`evento_id` ASC) ,
  INDEX `fk_fornecedor_has_fornecedor_fornecedor1_idx` (`fornecedor_id` ASC) ,
  CONSTRAINT `fk_fornecedor_has_fornecedor_fornecedor1`
    FOREIGN KEY (`fornecedor_id`)
    REFERENCES `hellow_eventos`.`fornecedor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fornecedor_has_fornecedor_fornecedor2`
    FOREIGN KEY (`evento_id`)
    REFERENCES `hellow_eventos`.`fornecedor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
